...
export function callExpression(
  callee?: Matcher<t.Expression | t.Super | t.V8IntrinsicIdentifier>,
  _arguments?:
    | Matcher<Array<t.Expression | t.SpreadElement | t.ArgumentPlaceholder>>
    | Array<
        | Matcher<t.Expression>
...
export class ClassAccessorPropertyMatcher extends Matcher<t.ClassAccessorProperty> {
  constructor(
...
export class DecimalLiteralMatcher extends Matcher<t.DecimalLiteral> {
  constructor(private readonly value?: Matcher<string> | string) {
    super()
  }
...
export function declareExportAllDeclaration(
  ...
  return new DeclareExportAllDeclarationMatcher(source, attributes)
}
...
export class FileMatcher extends Matcher<t.File> {
  constructor(
    ...
    private readonly comments?: Matcher<
      Array<t.CommentBlock | t.CommentLine>
    > | null,
...
export class MemberExpressionMatcher extends Matcher<t.MemberExpression> {
  constructor(
    ...
    >,
    private readonly computed?: Matcher<boolean> | boolean,
    private readonly optional?: Matcher<boolean> | boolean | null
  ) {
    super()
  }
...
export function memberExpression(
  ...
  computed?: Matcher<boolean> | boolean,
  optional?: Matcher<boolean> | boolean | null
...
export class ModuleExpressionMatcher extends Matcher<t.ModuleExpression> {
  constructor(private readonly body?: Matcher<t.Program>) {
    super()
  }
...
export function optionalMemberExpression(
  object?: Matcher<t.Expression>,
  property?: Matcher<t.Expression | t.Identifier>,
  computed?: Matcher<boolean> | boolean,
  optional?: Matcher<boolean> | boolean
...
export class RecordExpressionMatcher extends Matcher<t.RecordExpression> {
  constructor(
    private readonly properties?:
      | Matcher<Array<t.ObjectProperty | t.SpreadElement>>
      | Array<Matcher<t.ObjectProperty> | Matcher<t.SpreadElement>>
  ) {
    super()
  }
...
export class TSEnumBodyMatcher extends Matcher<t.TSEnumBody> {
  ...
  matchValue(
    ...
    if (!t.isNode(node) || !t.isTSEnumBody(node)) {
      return false
    }
...
export function tsEnumBody(
  ...
  return new TSEnumBodyMatcher(members)
}
...
export class TSInstantiationExpressionMatcher extends Matcher<t.TSInstantiationExpression> {
  constructor(
    private readonly expression?: Matcher<t.Expression>,
    private readonly typeParameters?: Matcher<t.TSTypeParameterInstantiation> | null
  ) {
...
export class TSSatisfiesExpressionMatcher extends Matcher<t.TSSatisfiesExpression> {
  constructor(
    private readonly expression?: Matcher<t.Expression>,
    private readonly typeAnnotation?: Matcher<t.TSType>
  ) {
...
export class TSTemplateLiteralTypeMatcher extends Matcher<t.TSTemplateLiteralType> {
  constructor(
  ...
  matchValue(
    ...
    if (!t.isNode(node) || !t.isTSTemplateLiteralType(node)) {
      return false
    }
...
export function tsTemplateLiteralType(
  ...
  return new TSTemplateLiteralTypeMatcher(quasis, types)
}
...
export function tsTypeOperator(
  ...
  return new TSTypeOperatorMatcher(typeAnnotation, operator)
}
...
export class TupleExpressionMatcher extends Matcher<t.TupleExpression> {
  constructor(
    private readonly elements?:
      | Matcher<Array<t.Expression | t.SpreadElement>>
      | Array<Matcher<t.Expression> | Matcher<t.SpreadElement>>
  ) {
    super()
  }
...
export class VariableDeclaratorMatcher extends Matcher<t.VariableDeclarator> {
  constructor(
    private readonly id?: Matcher<t.LVal | t.VoidPattern>,
...
export function variableDeclarator(
  id?: Matcher<t.LVal | t.VoidPattern>,
...
export class VoidPatternMatcher extends Matcher<t.VoidPattern> {
  ...
  matchValue(
    ...
    if (!t.isNode(node) || !t.isVoidPattern(node)) {
      return false
    }
